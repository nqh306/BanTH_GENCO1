...
def main():
                ...
                if data_ct_khlcnt:
                    ...
                    data_telegram = {
                                    ...
                                    'TextMessage': ["🆕 KHLCNT MỚI" + '\n' + 
                                                    "Đơn vị: " + str(data_ct_khlcnt["TenDonVi"][0]) + '\n' +
    ...
    if not df_GOITHAU.empty:
        ...
        for i in range(0, df_GOITHAU['ID_GOITHAU'].count()):
            ...
            if df_GOITHAU['MA_TBMT'][i] is not None:
                    ...
                    if df_GOITHAU["bidRealityOpenDate"][i] != "":
                        ...
                        if data_mothau['bidSubmissionByContractorViewResponse'] != None:
                            if data_mothau['bidSubmissionByContractorViewResponse']['bidSubmissionDTOList'] != None:
                                ...
                                df_mothau = pd.concat([df_mothau, ], ignore_index=True)
    ...
    if not df_ct_khlcnt.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.KHLCNT",df_ct_khlcnt,False,"planID",df_ct_khlcnt["planID"])
        if success == True:
            print(message)
        else:
    ...
    if not df_GOITHAU.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.GOI_THAU",df_GOITHAU,False,"ID_GOITHAU",df_GOITHAU["ID_GOITHAU"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_GOITHAU_ct.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.GOI_THAU_CT",df_GOITHAU_ct,False,"MA_TBMT",df_GOITHAU_ct["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_GIAHAN.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.GIA_HAN",df_GIAHAN,False,"MA_TBMT",df_GIAHAN["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_lamro.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.LAM_RO",df_lamro,False,"MA_TBMT",df_lamro["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_kiennghi.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.KIEN_NGHI",df_kiennghi,False,"MA_TBMT",df_kiennghi["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_mothau.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.BIENBAN_MOTHAU",df_mothau,False,"MA_TBMT",df_mothau["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_DXKT.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.HSDXKT",df_DXKT,False,"MA_TBMT",df_DXKT["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_DXTC.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.HSDXTC",df_DXTC,False,"MA_TBMT",df_DXTC["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
    ...
    if not df_KQLCNT.empty:
        success, message = upload_dataframe_to_google_sheet("token-qldt.json","1lfkxn5sPh1lqTmyvUe3jSyXNXu2ZG0CSiMEuyId6TaE","2.1.KQLCNT",df_KQLCNT,False,"MA_TBMT",df_KQLCNT["MA_TBMT"])
        if success == True:
            print(message)
        else:
            print(f"Upload failed. Error message: {message}")
